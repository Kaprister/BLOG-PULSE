                ...
                <Container>
                    <div className="flex flex-col md:flex-row md:my-14 items-center justify-around">
                        ...
                        <div className='md:w-[40%] flex flex-col items-center md:items-start '>
                            ...
                            <p className='md:text-left mt-6 text-center px-5 md:px-0'>Welcome to our place for cool stuff to read, smart ideas, and more. Dive into our blog app and have fun reading!</p>
                            <Button 
